	...
	actions: {
		login({ commit }, user) {
			return new Promise((resolve, reject) => {
				__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.post('/signin', user).then(function (response) {
		...
		register({ commit }, user) {
			return new Promise((res, rej) => {
				__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.post('/register', user).then(response => {
					res();
				}, response => {
					rej();
				});
		...
		checkAuth({ commit }) {
			if (localStorage.getItem('id_token') !== null) {
				__WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.get('/user').then(response => {
					commit('SET_USER', response.data.data);
				});
			}
		},
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-55e31053"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3d5e1231"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-56bda144"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-42955799"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-fa361ca2"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4bc40904"
...
/* harmony default export */ exports["default"] = {
  ...
  methods: {
    add() {
      if (this.errors.errors.length != 0 || this.newpost.img == null || this.newpost.body == null || this.newpost.title == null) {
      ...
      this.$http.post('/p', post, { emulateJSON: true }).then(res => {
...
/* harmony default export */ exports["default"] = {
	...
	methods: {
		...
		getPictures(page = 1) {
			this.$http.get(`/p?dir=${ this.sortDir }&page=${ page }`).then(function (response) {
		...
		paginate(res) {
			...
			if (res.next_page_url) this.pagination.next = res.next_page_url[res.next_page_url.length - 1];
			if (res.prev_page_url) this.pagination.prev = res.prev_page_url[res.prev_page_url.length - 1];
		},
		del(p) {
			this.pictures.splice(this.pictures.indexOf(p), 1);
			this.$http.delete('/p/' + p.id).then(() => {}, err => {
				console.log(err);
			});
		}
	},
...
/* harmony default export */ exports["default"] = {
	...
	methods: {
		getPost(id) {
			this.$http.get('/p/' + id).then(function (response) {
...
/* harmony default export */ exports["default"] = {
  ...
  methods: {
    add() {
      ...
      this.$http.post('/p/' + this.newpost.id, picture, { emulateJSON: true }).then(res => {
        this.block.error = null;
...
// module
exports.push([module.i, "footer{height:100px;background-color:#000;color:#fff}", ""]);
...
// module
exports.push([module.i, ".navbar[data-v-2b5b8b4a]{background-color:#31708f}.navbar-default .navbar-nav>li>a[data-v-2b5b8b4a]{color:#fff}.navbar-default .navbar-nav>li>a[data-v-2b5b8b4a]:hover{background-color:#145271}.navbar-text[data-v-2b5b8b4a]{color:#fff}", ""]);
...
// module
exports.push([module.i, "#main{min-height:500px;margin-top:70px}", ""]);
...
// module
exports.push([module.i, ".wrap[data-v-42955799]{width:100%;display:flex;flex-direction:row;justify-content:center;align-content:center}.wrap img[data-v-42955799]{width:640px;height:480px}.wrap p[data-v-42955799]{width:500px}", ""]);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2b5b8b4a"
...
module.exports={render:function (){var _vm=this;
  ...
  return _vm._h('footer', [_vm._h('h3', {
...
module.exports={render:function (){var _vm=this;
  return _vm._h('nav', {
  ...
  }, [(!_vm.user) ? [_vm._h('li', [_vm._h('router-link', {
    attrs: {
      "to": {
        name: 'login'
      }
    ...
    staticClass: "glyphicon glyphicon-add"
  }), "\n\t\t\t\t\t\t\tCreate picture\n\t\t\t\t\t\t"])]), " ", _vm._h('li', [_vm._h('a', {
    attrs: {
      "href": "#"
    },
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
  ...
  }, [(_vm.pictures && _vm.pictures != 'null') ? [_vm._h('a', {
    attrs: {
      "disabled": _vm.sortDir == 'asc' ? true : false,
      "href": "#"
    },
    on: {
      "click": function($event) {
    ...
    attrs: {
      "disabled": _vm.sortDir == 'desc' ? true : false,
      "href": "#"
    },
    on: {
      "click": function($event) {
    ...
    return [_vm._h('li', {
      ...
      staticClass: "media-object thumbnail img-thumbnail",
      attrs: {
        "src": picture.thumb,
        "alt": picture.title
      }
    ...
    }, [_vm._s(picture.title)])]), "\t\r\n\t\t\t\t\t\t" + _vm._s(picture.description.substr(0, 100)) + "\r\n\t\t\t\t\t\t", _vm._h('br'), " ", _vm._h('strong', ["Created: " + _vm._s(picture.created_at)]), " ", (_vm.user) ? [_vm._h('br'), " ", _vm._h('button', {
    ...
    on: {
      "click": function($event) {
        _vm.getPictures(_vm.pagination.prev)
      }
    }
  }, ["\r\n\t\t\t\tPrevious\t\t\t\t\r\n\t\t\t\t"]), " ", _vm._h('span', ["Page " + _vm._s(_vm.pagination.cur) + " of " + _vm._s(_vm.pagination.last)]), " ", _vm._h('button', {
    staticClass: "btn btn-default",
    attrs: {
    ...
    on: {
      "click": function($event) {
        _vm.getPictures(_vm.pagination.next)
      }
    }
  }, ["\r\n\t\t\t\tNext\t\t\t\t\r\n\t\t\t\t"])])] : _vm._e(), " ", (!_vm.pictures) ? [_vm._h('div', {
    staticClass: "row"
  }, [_vm._h('div', {
    staticClass: "col-md-12"
  }, [_vm._h('div', {
    staticClass: "jumbotron"
  }, [_vm._h('h2', ["Sorry, but we don`t have the pictures:("]), " ", (_vm.user) ? [_vm._h('p', ["\r\n\t\t\t\t\t\tAdd something incredible\r\n\t\t\t\t\t"]), " ", _vm._h('p', [_vm._h('router-link', {
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
    ...
    staticClass: "text-center"
  }, ["Add picture"]), " ", _vm._h('div', {
    staticClass: "col-md-7 col-md-offset-1"
  }, [(_vm.block.error) ? _vm._h('div', {
    staticClass: "alert alert-danger alert-dismissible",
    attrs: {
      "role": "alert"
    }
  }, [_vm._m(0), " ", _vm._h('strong', ["Oh snap!"]), " " + _vm._s(_vm.block.error) + "\n\t\t"]) : _vm._e(), " ", (_vm.block.success) ? _vm._h('div', {
    staticClass: "alert alert-success alert-dismissible",
    attrs: {
      "role": "alert"
    }
  }, [_vm._m(1), " ", _vm._h('strong', ["Well done!"]), " " + _vm._s(_vm.block.success) + "\n\t\t"]) : _vm._e(), " ", _vm._h('form', {
    ...
    domProps: {
      "value": _vm._s(_vm.newpost.title)
    },
    on: {
  ...
  }), " ", (_vm.errors.has('title')) ? _vm._h('p', {
    staticClass: "text-danger"
  }, ["\n\t\t\t\t\t\t" + _vm._s(_vm.errors.first('title')) + "\n\t\t\t\t\t"]) : _vm._e()])]), " ", _vm._h('div', {
    staticClass: "form-group",
    class: {
      'has-error': _vm.errors.has('body')
    }
  }, [_vm._h('label', {
    staticClass: "col-sm-2 control-label"
  ...
  }), " ", (_vm.errors.has('body')) ? _vm._h('p', {
    staticClass: "text-danger"
  }, ["\n\t\t\t\t\t\t" + _vm._s(_vm.errors.first('body')) + "\n\t\t\t\t\t"]) : _vm._e()])]), " ", _vm._h('div', {
    staticClass: "form-group"
  }, [_vm._h('div', {
...
module.exports={render:function (){var _vm=this;
  return (_vm.picture) ? _vm._h('div', {
    ...
    staticClass: "img img-thumbnail",
    attrs: {
      "src": _vm.picture.picture,
      "alt": _vm.picture.title
    }
  })]), " ", _vm._h('br'), " ", _vm._h('div', {
    staticClass: "wrap text-center"
  }, [_vm._h('p', [_vm._s(_vm.picture.description)])]), "\r\n\t\tViews:" + _vm._s(_vm.picture.views) + " ", _vm._h('br'), "\r\n\t\tCreated: " + _vm._s(_vm.picture.created_at) + " ", _vm._h('br')])]) : _vm._e()
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
    ...
    domProps: {
      "value": _vm._s(_vm.newpost.description)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newpost.description = $event.target.value
      }
    }
  }), " ", (_vm.errors.has('description')) ? _vm._h('p', {
    staticClass: "text-danger"
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
  ...
  }, [(_vm.notAuth) ? _vm._h('div', {
    staticClass: "alert alert-danger alert-dismissible",
    attrs: {
      "role": "alert"
    }
  }, [_vm._m(0), " ", _vm._h('strong', ["Oh snap!"]), " " + _vm._s(_vm.notAuth) + "\n\t\t"]) : _vm._e(), " ", _vm._h('form', {
    staticClass: "form-horizontal"
  }, [_vm._h('div', {
    staticClass: "form-group",
    class: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.loginU.email),
      expression: "loginU.email"
    }, {
      name: "validate",
      rawName: "v-validate"
    }],
    ...
    domProps: {
      "value": _vm._s(_vm.loginU.email)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.loginU.email = $event.target.value
      }
    }
  }), " ", (_vm.errors.has('email')) ? _vm._h('p', {
    staticClass: "text-danger"
    ...
    directives: [{
      ...
      name: "model",
      rawName: "v-model",
      value: (_vm.loginU.password),
      expression: "loginU.password"
    }],
    staticClass: "form-control",
    attrs: {
      "data-vv-rules": "required",
    ...
    domProps: {
      "value": _vm._s(_vm.loginU.password)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.loginU.password = $event.target.value
      }
    }
  }), " ", (_vm.errors.has('password')) ? _vm._h('p', {
    staticClass: "text-danger"
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
    ...
    staticClass: "col-md-5"
  }, [(_vm.notReg) ? _vm._h('div', {
    staticClass: "alert alert-danger alert-dismissible",
    attrs: {
      "role": "alert"
    }
  }, [_vm._m(0), " ", _vm._h('strong', ["Oh snap!"]), " " + _vm._s(_vm.notReg) + "\n\t\t"]) : _vm._e(), " ", _vm._h('form', {
    staticClass: "form-horizontal"
  }, [_vm._h('div', {
    staticClass: "form-group",
    class: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.loginU.name),
      expression: "loginU.name"
    }, {
      name: "validate",
      rawName: "v-validate"
    }],
    ...
    domProps: {
      "value": _vm._s(_vm.loginU.name)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.loginU.name = $event.target.value
      }
    }
  }), " ", (_vm.errors.has('name')) ? _vm._h('p', {
    staticClass: "text-danger"
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0a292758!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./footer.vue", function() {
			var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0a292758!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./footer.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2b5b8b4a&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue", function() {
			var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2b5b8b4a&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-39cb8720!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-39cb8720!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3d5e1231&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./create.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3d5e1231&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./create.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-42955799&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./picture.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-42955799&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./picture.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4bc40904&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4bc40904&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-55e31053&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./404.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-55e31053&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./404.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-56bda144&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./login.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-56bda144&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./login.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-fa361ca2&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./reg.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-fa361ca2&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./reg.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_moment__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_router__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_index_js__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vee_validate__ = __webpack_require__(114);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_moment___default.a);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    render: h => h(__webpack_require__(115))
});
